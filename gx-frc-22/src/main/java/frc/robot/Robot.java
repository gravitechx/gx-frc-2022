...
import frc.robot.commands.DriveManualVelocity;
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    OI.getInstance(); // init button bindings and joysticks
    CommandScheduler.getInstance().setDefaultCommand(Drivetrain.getInstance(), new DriveManualVelocity());
  }
